...
app.post("/players-record/:playerId", authenticateJWT, async (req, res) => {
  try {
    ...
    const { goalScored, goalAssists } = req.body;

    // Build update object dynamically
    const updateFields = {};
    if (goalScored !== undefined) updateFields.goalsScored = goalScored;
    if (goalAssists !== undefined) updateFields.goalsAssists = goalAssists;
